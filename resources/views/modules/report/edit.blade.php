       ...
       <div class="row">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit necessary Information</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{url('report/edit/'.$report->id)}}" method="post">
            {!! csrf_field() !!}
              <div class="box-body">
                <div class="form-group {{ $errors->has('patient') ? ' has-error' : '' }}">
                  ...
                  <select class="form-control select2" name="patient">
                    ...
                    @foreach($patient as $key => $val)
                      <option value="{{$val->id}}" {{($report->patient_id == $val->id) ? 'selected' : ''}}>{{$val->name}}</option>
                    @endforeach
                  </select>
                 ...
                 <div class="form-group {{ $errors->has('clinical_history') ? ' has-error' : '' }}">
                  ...
                  <input type="text" name="clinical_history" class="form-control" id="exampleInputPassword1" placeholder="E.g. Large Gastric Mass" value="{{$report->clinical_history}}">
                 ...
                 <div class="form-group {{ $errors->has('specimen') ? ' has-error' : '' }}">
                  ...
                  <input type="text" name="specimen" class="form-control" id="exampleInputPassword1" placeholder="E.g. Gastric Mucosa" value="{{$report->specimen}}">
                ...
                <div class="form-group {{ $errors->has('diagnosis') ? ' has-error' : '' }}">
                  ...
                  <textarea name="diagnosis">{!! $report->diagnosis !!}</textarea>
                 ...
                 <div class="form-group {{ $errors->has('gross_description') ? ' has-error' : '' }}">
                  ...
                  <textarea name="gross_description">{!! $report->gross_description !!}</textarea>
